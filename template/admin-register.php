<style type="text/css">
  #register_message {margin-bottom: 10px;}
  #register_explanation {margin-top: 10px;}
  #register table {border-collapse: collapse;width: 100%;}
  #register table td.left {text-transform: capitalize;padding-left: 10px;width: 160px;/*min-width: 25%;*/text-align: inherit;}
  #register input[type=text] {width: 300px;direction: ltr;}
  #register select {width: 300px;}
</style>
...
<div class="wrap">
	...
	<?php echo $form_html; ?>
	<p class="submit">
		<input type="button" id="register_submit" name="Submit" class="button-primary" style="float: left; margin-right: 5px; margin-top:-4px;" value="<?php esc_attr_e('Continue', 'sweetcaptcha') ?>" />
